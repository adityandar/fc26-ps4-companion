...
export interface AppConfig { readonly companionRoot: string; readonly objectRoot: string; readonly databasePath: string; readonly host: string; readonly port: number; readonly currency: string }
